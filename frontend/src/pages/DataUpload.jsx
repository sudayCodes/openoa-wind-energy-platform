...
const DATASET_CONFIG = [
  {
    type: 'scada',
    label: 'SCADA Data',
    description: 'Turbine-level time series: power, wind speed, direction, status, pitch, temperature, etc.',
    color: 'blue',
  ...
  },
  {
    ...
    columnNames: ['time', 'IAVL_ExtPwrDnWh', 'IAVL_DnWh'],
  },
  {
    type: 'asset',
    label: 'Asset Data',
    description: 'Turbine metadata: location (lat/lon), rated power, hub height, rotor diameter, elevation, type.',
    color: 'cyan',
